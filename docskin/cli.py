...
@common_pdf_options
def github(repo: str, issue: int, api_base: str, css_style: Path, output: Path, logo: Path):
...
@common_pdf_options
def md(input: Path, output: Path, logo: Path, css_style: Path):
...
@common_pdf_options
def md_dir(input: Path, logo: Path, css_style: Path, output: Path):
